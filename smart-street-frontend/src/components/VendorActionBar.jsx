  ...
  return (
    <div className={`absolute bottom-6 left-1/2 -translate-x-1/2 w-full max-w-4xl px-4 z-[2000] ${className}`}>
      <form
        ...
        className="bg-white/95 backdrop-blur-md shadow-2xl rounded-2xl border border-slate-200 p-4 sm:p-5 flex flex-col gap-4"
      >
        <div className="flex flex-col md:flex-row gap-4 items-end">
          ...
          <div className="flex-1 w-full grid grid-cols-2 gap-3">
            <div>
              ...
              <input
                ...
                className="w-full text-sm rounded-lg border-slate-200 focus:ring-2 focus:ring-blue-500 py-2 px-3 bg-slate-50"
                required
              />
            </div>
            <div>
          ...
          <div className="w-full md:w-48">
            ...
            <input
              ...
              placeholder="e.g. 5"
              className={`w-full text-sm rounded-lg border-slate-200 py-2 px-3 ${
                isOwnerDefined ? "bg-slate-100 text-slate-500 cursor-not-allowed" : "bg-white focus:ring-2 focus:ring-blue-500"
              }`}
            />
            {isRequestNew && (
