                                ...
                                {analytics.recentRequests.map(req => (
                                    <div key={req.request_id} className="p-5 hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors flex items-center justify-between group">
                                        ...
                                        <button
                                            ...
                                            className="bg-slate-100 dark:bg-slate-800 hover:bg-blue-600 hover:text-white p-2.5 rounded-xl transition-all group-hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed shrink-0 ml-2"
                                        >
