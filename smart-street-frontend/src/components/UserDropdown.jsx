    ...
    return (
        <div className="relative" ref={dropdownRef}>
            ...
            >
                ...
                <div className="w-8 h-8 md:w-10 md:h-10 rounded-full bg-slate-200 dark:bg-slate-700 flex items-center justify-center text-slate-600 dark:text-slate-300 ring-2 ring-transparent group-hover:ring-blue-500/50 transition-all">
            ...
            {isOpen && (
                <div className="absolute right-0 mt-2 w-56 bg-white dark:bg-slate-800 rounded-xl shadow-lg border border-slate-200 dark:border-slate-700 py-1 overflow-hidden z-[3000] animate-in fade-in zoom-in-95 duration-100 origin-top-right">
