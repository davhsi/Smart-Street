      ...
      <div className="relative w-[90%] md:w-full max-w-md bg-white/60 dark:bg-white/5 backdrop-blur-xl shadow-2xl rounded-2xl p-6 md:p-8 border border-white/40 dark:border-white/10 z-10 transition-all hover:shadow-cyan-500/20">
        <div className="text-center space-y-3 mb-8">
          ...
          <Link to="/" className="block">
            <h1 className="text-3xl font-bold text-slate-800 dark:text-white tracking-tight hover:text-cyan-600 dark:hover:text-cyan-400 transition-colors">{t("app_name")}</h1>
          </Link>
        ...
        <form className="space-y-5" onSubmit={handleSubmit}>
          ...
          <div className="space-y-1 group">
            <label className="text-xs font-semibold text-slate-500 dark:text-slate-400 ml-1 uppercase tracking-wider">{t("email_address")}</label>
          ...
          {/* Password Field */}
          <div className="space-y-1 group">
            <label className="text-xs font-semibold text-slate-500 dark:text-slate-400 ml-1 uppercase tracking-wider">{t("password")}</label>
