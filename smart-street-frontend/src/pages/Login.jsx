...
export default function Login() {
  ...
  return (
    <div className="min-h-screen w-full flex bg-white dark:bg-[#0B1120] font-sans">
      ...
      {/* Right Panel - Form */}
      <div className="w-full lg:w-1/2 flex flex-col relative bg-slate-50/50 dark:bg-transparent">
        {/* Header / Nav */}
        <nav className="absolute top-0 w-full flex justify-between items-center p-6 gap-4 z-50 lg:justify-end">
        ...
        {/* Form Container */}
        <div className="flex-1 flex flex-col justify-center px-6 py-12 lg:px-16 w-full max-w-xl mx-auto z-10 mt-12 lg:mt-0">
          <div className="w-full animate-fade-in-up">
            
            <div className="space-y-3 mb-12">
              <h2 className="text-4xl font-black text-slate-900 dark:text-white tracking-tighter">{t("sign_in")}</h2>
            ...
            <form className="space-y-8" onSubmit={handleSubmit}>
              ...
              <div className="relative group">
                ...
                <div className="flex items-center gap-4 pb-3 border-b-2 border-slate-200 dark:border-slate-700/80 relative">
                  ...
                  <input
                    ...
                    required
                    className="w-full bg-transparent text-lg text-slate-800 dark:text-white placeholder-slate-400 dark:placeholder-slate-500 focus:outline-none font-semibold"
              ...
              <div className="relative group pt-2">
                ...
                <div className="flex items-center gap-4 pb-3 border-b-2 border-slate-200 dark:border-slate-700/80 relative">
                  ...
                  <input
                    ...
                    minLength={8}
                    required
                    className="w-full bg-transparent text-lg text-slate-800 dark:text-white placeholder-slate-400 dark:placeholder-slate-500 focus:outline-none font-semibold tracking-wide"
              ...
              <div className="flex items-center justify-between text-sm font-semibold mt-2">
                <label className="flex items-center gap-2.5 cursor-pointer text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-slate-200 transition-colors">
                  <input type="checkbox" className="w-4.5 h-4.5 rounded border-slate-300 text-cyan-500 focus:ring-cyan-500 dark:border-slate-600 dark:bg-slate-800 focus:ring-offset-0 transition-all" />
                  {t("remember_me")}
                </label>
                <Link to="/forgot-password" className="text-cyan-600 dark:text-cyan-400 hover:text-cyan-700 dark:hover:text-cyan-300 transition-colors hover:underline">
                  {t("forgot_password")}
                </Link>
              </div>
          ...
          <div className="mt-auto pt-12 text-center text-sm text-slate-400 dark:text-slate-500 font-medium lg:hidden">
            {t("footer_secure")}
          </div>
        </div>
      </div>
